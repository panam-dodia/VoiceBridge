...
function SessionCardSkeleton() {
  return (
    <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 animate-pulse">
...
// Skeleton loader for session details
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3 mt-6">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="p-4 bg-black/20 rounded-lg border border-white/5 animate-pulse">
            ...
            {qaLoading && (
              <div className="mt-4 p-4 bg-white/5 rounded-xl border border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-300 text-sm">Searching through your history and generating answer...</p>
                  </div>
                </div>
              </div>
            )}
